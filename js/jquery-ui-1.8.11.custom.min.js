...
(function(d) {
    d.widget("ui.draggable", d.ui.mouse, {
        ...
        _mouseStart: function(a) {
            ...
            this.originalPageY = a.pageY;//alert(a.pageX);
            ...
            this.helper.addClass("ui-draggable-dragging dragged_product");
            this.helper.attr('id', 'dragged_product');
			document.getElementById('body_mask').style.display = 'block';
			$(".drop_cart").css('width','140');
			$(".drop_cart").css('height','150');
			$(".magnet_area").css('background-color','#FDAF42');
			$(".drop_cart").addClass('drop_area');
			//product_id = 58;
        ...
        _mouseDrag: function(a, b) {
            ...
            d.ui.ddmanager && d.ui.ddmanager.drag(this, a);//alert(1);
						var screenW = $('body').innerWidth();
						var screenH = $('body').height();
			/*if  ((screenW <= mousePos.x || mousePos.x < 0) || ($(document).height() <= mousePos.y || mousePos.y < 0)){
				
			}*/
			/*var product_position = $('#dragged_product');//console.log(position1);//alert(position.position().x);
			var coordinate = product_position.offset();
			if ((((coordinate.left + product_position.width()) >= screenW) || coordinate.left <= 0) || (((coordinate.top + product_position.height()) >= screenH) || coordinate.top <= 0)){
				//alert(1920);
			}*/
			var product_position = $('#dragged_product');//console.log(position1);//alert(position.position().x);
			var coordinate = product_position.offset();
			var cart = $('#drop_cart');
			var cart_coordinate = cart.offset();
			/*if (((coordinate.left + product_position.width()) >= cart_coordinate.left && (coordinate.right + product_position.width()) <= cart_coordinate.right) || ((coordinate.top + product_position.height()) >= cart_coordinate.top && (coordinate.bottom + product_position.height()) <= cart_coordinate.bottom)){
				$('#magnet_area').css('border','2px solid #859697');
			}*/
			if ((((coordinate.left + product_position.width() >= cart_coordinate.left && (coordinate.top + product_position.height()) >= cart_coordinate.top)) && ((coordinate.left + product_position.width() <= cart_coordinate.left + cart.width()  + 20 && (coordinate.top + product_position.height()) <= cart_coordinate.top + cart.height() + 20))
				) || ( (coordinate.left + product_position.width() <= cart_coordinate.left + cart.width() + 20 && coordinate.left + product_position.width() >= cart_coordinate.left + 20 ) && (coordinate.top <= cart_coordinate.top + cart.height()) && (coordinate.top >= cart_coordinate.top))){
				$('#magnet_area').css('border','10px solid #F94646');
			}
			else{
				$('#magnet_area').css('border','10px solid transparent');
			}
        ...
        _mouseStop: function(a) {
			...
			$(".magnet_area").css('background-color','#EDEDED');
            var b = false;
        ...
        _clear: function() {
            ...
            this.helper = null;document.getElementById('body_mask').style.display = 'none';//alert(b.product_id);
			$('#magnet_area').css('border','10px solid transparent');
