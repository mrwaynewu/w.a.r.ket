...
(function(e, d, a, f) {
    ...
    e.fn.twbsPagination.defaults = {
        ...
        href: false,
        hrefVariable: "{{number}}",
        first: "<i class=\"fa fa-angle-double-left\" style=\"font-size: 12px;line-height: 1.5;\"></i>",
        prev: "<i class=\"fa fa-angle-left\" style=\"font-size: 12px;line-height: 1.5;\"></i>",
        next: "<i class=\"fa fa-angle-right\" style=\"font-size: 12px;line-height: 1.5;\"></i>",
        last: "<i class=\"fa fa-angle-double-right\" style=\"font-size: 12px;line-height: 1.5;\"></i>",
        loop: false,
        onPageClick: null,
