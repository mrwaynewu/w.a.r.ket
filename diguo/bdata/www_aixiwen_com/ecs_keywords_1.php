...
E_D("replace into `ecs_keywords` values('2014-07-21','ecshop','美体小铺','1');");
E_D("replace into `ecs_keywords` values('2014-07-22','ecshop','美体小铺','1');");
E_D("replace into `ecs_keywords` values('2014-07-24','ecshop','fgg','1');");
E_D("replace into `ecs_keywords` values('2014-07-24','ecshop','1','1');");
E_D("replace into `ecs_keywords` values('2014-07-24','ecshop','美体小铺','2');");
E_D("replace into `ecs_keywords` values('2014-07-24','ecshop','\\\\u7F8E\\\\u4F53\\\\u5C0F\\\\u94FA\\\\\\\\\\\\'' aNd \\\\\\\\\\\\''7\\\\\\\\\\\\''=\\\\\\\\\\\\''7','2');");
E_D("replace into `ecs_keywords` values('2014-07-24','ecshop','!S!WCRTESTINPUT000000!E!','1');");
E_D("replace into `ecs_keywords` values('2014-07-24','ecshop','\\\\u7F8E\\\\u4F53\\\\u5C0F\\\\u94FA\\\\\\\\\\\\'' aNd \\\\\\\\\\\\''7\\\\\\\\\\\\''=\\\\\\\\\\\\''2','1');");
E_D("replace into `ecs_keywords` values('2014-07-24','ecshop','!S!WCRTESTINPUT000000!E!\\\\\\\\\\\\'' aNd \\\\\\\\\\\\''7\\\\\\\\\\\\''=\\\\\\\\\\\\''7','1');");
E_D("replace into `ecs_keywords` values('2014-07-24','ecshop','!S!WCRTESTINPUT000000!E!\\\\\\\\\\\\'' aNd \\\\\\\\\\\\''7\\\\\\\\\\\\''=\\\\\\\\\\\\''2','1');");
E_D("replace into `ecs_keywords` values('2014-07-24','ecshop','1 aNd 7=7','1');");
E_D("replace into `ecs_keywords` values('2014-07-24','ecshop','1 aNd 7=2','1');");
E_D("replace into `ecs_keywords` values('2014-07-24','ecshop','99999999 oR 7=7','1');");
E_D("replace into `ecs_keywords` values('2014-07-24','ecshop','99999999 oR 7=2','1');");
E_D("replace into `ecs_keywords` values('2014-07-25','ecshop','美体小铺','2');");
E_D("replace into `ecs_keywords` values('2014-07-25','ecshop','???????','1');");
E_D("replace into `ecs_keywords` values('2014-07-25','ecshop','手机','1');");
E_D("replace into `ecs_keywords` values('2014-07-25','ecshop','安娜','1');");
E_D("replace into `ecs_keywords` values('2014-07-26','BAIDU','q.yunmoban.cn','1');");
E_D("replace into `ecs_keywords` values('2014-07-28','BAIDU','ECSHOP妯℃澘鍫傜背濂囩綉2014鑷冲皧鏃楄埌鐗','1');");
E_D("replace into `ecs_keywords` values('2014-07-28','ecshop','121','1');");
E_D("replace into `ecs_keywords` values('2014-07-28','ecshop','fgf','1');");
E_D("replace into `ecs_keywords` values('2014-07-28','ecshop','Huaz','1');");
E_D("replace into `ecs_keywords` values('2014-07-28','ecshop','美体小铺','1');");
E_D("replace into `ecs_keywords` values('2014-07-28','ecshop','11','1');");
