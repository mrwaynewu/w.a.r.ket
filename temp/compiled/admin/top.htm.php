...
<link href="styles/bootstrap-3.3.5-dist/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
...
#menu-div {
  ...
  height: 24px;
  line-height:24px;
  -webkit-box-shadow: 0px 11px 10px 1px rgba(0,0,0,0.09);
-moz-box-shadow: 0px 11px 10px 1px rgba(0,0,0,0.09);
box-shadow: 0px 11px 10px 1px rgba(0,0,0,0.09);
}
...
<div id="header-div">
  ...
  <div id="submenu-div">
    ...
    <div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
      ...
      <?php endif; ?>
      <a href="index.php?act=clear_cache" target="main-frame" class="label label-info" style="color:#fff;font-size:0.9em;"><?php echo $this->_var['lang']['clear_cache']; ?></a>
      <a href="privilege.php?act=logout" target="_top" class="label label-danger" style="color:#fff;font-size:0.9em;"><?php echo $this->_var['lang']['signout']; ?></a>
    </div>
    <?php if ($this->_var['send_mail_on'] == 'on'): ?>
