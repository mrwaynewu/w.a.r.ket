...
{
	global $_LANG;
	$_LANG['help']['APP_KEY'] = '在 developers.facebook.com 里申请的 App Key';
	$_LANG['help']['APP_SECRET'] = '请注意填写，最长的就填此处';
	$_LANG['help']['facebook_version'] = '勾选使用 Oauth2.0版本 验证方法 , 否则采用 1.0a 版本验证方案';
	$_LANG['APP_KEY'] = 'App Key';
	$_LANG['APP_SECRET'] = 'App Secret';
	$_LANG['facebook_version'] = '是否使用Oauth2.0版本';
	...
	// 作者信息
	$web[$i]['author'] = '`Wayne@PBCC\'';
	
	$web[$i]['className'] = 'facebook';
	
	// 作者QQ
	$web[$i]['qq'] = '88307550';
	
	// 作者邮箱
	$web[$i]['email'] = 'it@pbcc.ca';
	
	// 申请网址
	$web[$i]['website'] = 'http://developers.facebook.com/apps';
	
	// 版本号
	$web[$i]['version'] = '2.7v';
	
	// 更新日期
	$web[$i]['date']  = '2015-08-18';
...
if (!defined('WEBSITE'))
{
	...
	class website extends oath2
	{
		function website()
		{
			...
			$this->tokenURL = 'https://api.facebook.com/oauth2/access_token';
			$this->authorizeURL = 'https://www.facebook.com/v2.4/dialog/oauth';
			$this->display = 'popup';
			$this->userURL = 'https://api.facebook.com/2/users/show.json';
			$this->meth = 'POST';
		}
		function sign( &$p ){
			$this->meth = 'GET';
