<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:52:"/var/www/html/warket/mobile/themes/default/goods.dwt";i:1;s:63:"/var/www/html/warket/mobile/themes/default/library/comments.lbi";i:2;s:66:"/var/www/html/warket/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1440570770;s:8:"maketime";i:1440567170;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>六必居芝麻酱 300g_百味铺_ECTouch企业版演示站 触屏版</title>
...
<header id="header">
  ...
  <h1> 商品详情 </h1>
  <div class="header_r header_search"> <a class="ico_15" href="ectouch.php?act=share&content=六必居芝麻酱 300g&pic=images/201508/source_img/181_G_1439570859224.png"> 分享 </a> </div>
</header>
...
<section class="goods_slider">
  ...
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201508/thumb_img/181_thumb_G_1439570859403.jpg"  alt="六必居芝麻酱 300g" /></a></div>-->
      <ul>
        <li><a href="javascript:showPic()"><img alt="" src="http://q.yunmoban.cn/images/201508/source_img/181_G_1439570859224.png"/></a></li>
         
         
         
         
                <li><a href="javascript:showPic()"><img alt="" src="http://q.yunmoban.cn/images/201508/goods_img/181_P_1439570859547.png"/></a></li>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(181)" style="display: inline;"></a>
  <div class="title">
    <h1> 六必居芝麻酱 300g </h1>
  </div>
  <ul>
        <li>本店售价：<b class="price">￥3元</b>　    <del>￥0元</del> 
    </li>
     
	    <li>我的价格：<b class="price" id="ECS_RANKPRICE_1">￥3元</b></li>
        <li>我的价格：<b class="price" id="ECS_RANKPRICE_2">￥3元</b></li>
        <li>我的价格：<b class="price" id="ECS_RANKPRICE_99">￥3元</b></li>
      </ul>
    ...
    <form action="javascript:addToCart(181)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
     <div class="fields">	 
      ...
      <div class="option" > 
        ...
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(181)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(181);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://q.yunmoban.cn/images/201508/source_img/181_G_1439570859224.png"> </div>
            <div id="right">
              <p>六必居芝麻酱 300g</p>
...
<section class="s-detail">
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:181;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
