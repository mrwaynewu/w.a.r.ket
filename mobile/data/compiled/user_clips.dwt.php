...
<dl class="user_top">
  ...
  <div class="user_top_list">
    <ul>
      ...
      <li> <a href="javascript:;"> <strong><?php echo $this->_var['info']['integral']; ?></strong> <img  src="<?php echo $this->_var['ectouch_themes']; ?>/images/ico_user_02.png"> <span>积分</span> </a> </li>
      <li> <a href="javascript:;"> <strong><?php echo $this->_var['info']['surplus']; ?></strong> <img  src="<?php echo $this->_var['ectouch_themes']; ?>/images/ico_user_03.png"> <span>余额</span> </a> </li>
